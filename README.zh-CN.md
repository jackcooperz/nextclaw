...
- **QQ 群**（群号 1084340143）— 扫码加群：
  ...
  ![QQ 群二维码](images/contact/nextclaw-contact-qq-group.jpg)
...
从 [GitHub Releases](https://github.com/Peiiii/nextclaw/releases/latest) 下载：
...
安装后点击桌面或开始菜单中的 **Start NextClaw** 即可启动。
Beta 提示：桌面安装包仍处于 Beta 阶段，可能存在问题。
